			  ...
			  <div class="panel-body">
				<form role="form" id="roleForm">
				  ...
				  <div class="form-group">
					...
					<input type="text" class="form-control" name="roleName" id="roleName" placeholder="请输入角色名" value="${requestScope.role.roleName }">
				  </div>
				  <button type="button" onclick="saveRole(${requestScope.role.id})" class="btn btn-success"><i class="glyphicon glyphicon-plus"></i> 保存</button>
				  <button type="button" onclick="resetRole()" class="btn btn-danger"><i class="glyphicon glyphicon-refresh"></i> 重置</button>
				</form>
			  </div>
			</div>
        </div>
	...
	<script src="${pageContext.request.contextPath }/layer/layer.js"></script>
        <script type="text/javascript">
            ...
            function saveRole(id){
            	var url = '';
            	if(id != null){
            		url = '${pageContext.request.contextPath }/role/doUpdate';
            	}else{
            		url = '${pageContext.request.contextPath }/role/doAdd';
            	}
            	$.ajax({
            		type: "POST",
            		url: url,
